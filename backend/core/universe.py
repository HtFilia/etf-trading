...
def _default_universe() -> Universe:
    ...
    securities = [
        ...
        Security(id="ETF_SP500",   isin=None, ticker="SPYx",  name="S&P 500 Tracker (sim)",     exchange_id="XNYS", currency="USD", type="ETF"),
        Security(id="ETF_CSI1000", isin=None, ticker="CSI1k", name="CSI 1000 Tracker (sim)",    exchange_id="XSHG", currency="CNY", type="ETF"),
        Security(id="ETF_CAC40",   isin=None, ticker="CACx",  name="CAC 40 Tracker (sim)",       exchange_id="XPAR", currency="EUR", type="ETF"),
        Security(id="ETF_MSCI_W",  isin=None, ticker="MSCIw", name="MSCI World Tracker (sim)",   exchange_id="XETR", currency="EUR", type="ETF"),
        Security(id="ETF_STOXX600",isin=None, ticker="STOXX", name="EURO STOXX 600 Tracker (sim)",exchange_id="XETR", currency="EUR", type="ETF"),
